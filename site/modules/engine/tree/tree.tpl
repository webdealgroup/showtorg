...
~~include file="engine/tree/items/items.tpl"~

/*** imgs  new ************************************************/	

~~include file="engine/tree/imgs/imgs.tpl"~

/**** gallery ***********************************************/		
	
~~include file="engine/tree/gallery/gallery.tpl"~
	
/**** my_tree ***********************************************/		
		
~~include file="engine/tree/my_tree/my_tree.tpl"~
