          ...
          <div class="mbr-table">
            <div class="mbr-table-cell">
                        ...
                        <div class="navbar-brand">
                            <a href="/" class="navbar-logo"><img src="/img/logo.svg" alt="Mobirise"></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-xs-center" style='color:white;'>
                    <h3 class="mbr-section-title display-2">~~$categories[$p_index].name~</h3>
                    <div class="lead" style="font-family: Arial;"><p><a href="tel:+74956652357" style="font-size: 1.5rem;">Закзаз по телефону:  <span style=" white-space: nowrap;">8 (495) 665-23-57</span></a></p>
                      <p><a href="tel:+79680775547" style="font-size: 1.5rem;">Круглосуточный расчет:  <span style=" white-space: nowrap;">8 (968) 077-55-47</span></a></p></div> 
