                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="content_width_td">
                                                                        ...
                                                                        <tr><td class="main"></td></tr>
                                                                                        ...
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="infoBoxHeading2_table" style="width: 739px;">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
                                                                        ...
                                                                        <table class="cont_heading_table" border="0" cellpadding="0" cellspacing="0" width="100%" style="display:none;">
                                                                            <tbody>
                                                                                <tr>
...
<body>
	...
	<div id=panel_center><div id=panel_center_wrapper>~~include file="center.tpl"~</div></div>
