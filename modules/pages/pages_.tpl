~~include file="htmlhead.tpl"~
    ...
    <div style="background: none repeat scroll 0px 0px rgb(255, 255, 255); border-radius: 5px 5px 5px 5px; box-shadow: 0px 0px 32px rgba(0, 0, 0, 0.22); margin: 0px auto; position: relative; width: 1151px;">
            <!-- header //--><!-- start -->
                ...
                <tr>
                    <td style="background: url(&quot;images/head_bg.jpg&quot;) repeat-x scroll 0px 147px transparent;">
                        <table class="col_c_table" align="center" border="0" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="content_width_td">
                                                                        ...
                                                                        <tr><td class="main"></td></tr>
                                                                                        ...
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="infoBoxHeading2_table" style="width: 758px; margin-bottom:10px;margin-right:10px;">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <img width="9" height="38" border="0" alt="" src="index_files/corner_top2_left.gif">
                                                                                                    </td>
                                                                                                    <td class="infoBoxHeading2_td">
                                                                                                        ~~$page_arr.title~
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <img width="9" height="38" border="0" alt="" src="index_files/corner_top2_right.gif">
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                            ...
                            <div class="m_bg" style=" margin-bottom:10px;margin-right:10px;">
								<div class="m_tl">
									<div class="m_tr">
										<div class="m_bl">
											<div class="m_br">
...
<body>
   ...
   <div id=panel_center><div id=panel_center_wrapper>~~mod mod_name="banner_epson" action=""~<div class="content">~~$content~</div></div></div>
