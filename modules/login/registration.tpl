...
//			},
		...
		messages: {
			...
			confirm_password: "Подтверждение пароля не совпадает с введенным паролем"
		},
                            ...
                            <div id="registration_content">
                                <form method="post" name="registration" id="registration">
                                      <table border="0" cellpadding="2" cellspacing="2" width="100%">
                                        ...
                                        <tr>
                                          <td class="main"><br /><input src="index_files/button_reg.gif" style="border: 0pt none ;" alt="Регистрация" title=" Регистрация " type="image"></td></td>
                                        </tr>
                                        </tbody>
                                      </table>
                                </form>
