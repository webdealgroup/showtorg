                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="content_width_td">
                                                                        ...
                                                                        <table class="cont_heading_table" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
...
<body>
   ...
   <div id=panel_center><div id=panel_center_wrapper>
   		~~$content~
