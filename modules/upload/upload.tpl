	...
	<table cellpadding="2" style="font-family:Hevletica;font-size:13px;">
		...
		~~/foreach~
			...
			<tr bgcolor="#FFFFCC">
				...
				<td  align="center" ><a href='/?page=upload&action=rdfile&adres=~~$adres~&id=~~$item.p_5~'>Удалить</a></td>
			</tr>
		~~/foreach~
		<tr>
			<td align=center>
		...
		<tr>
			<td>
				...
				<table border=0 align=center cellpadding=2 cellspacing=1 >
					...
					<tr height=25><td colspan=3><font color=red>*</font> <B style="font-family:Arial;font-size:13px;">Если директории нет, то введите её </B></TD></TR>
					<tr>
						<td align=left  style="font-family:Arial;font-size:13px;">Новая папка</td>
					</tr>
					<tr>	
        ...
        <tr>
		 <td >
			<form action='/?page=upload' method='post' name='formd' enctype='multipart/form-data'>
				<table border=0 align=center cellpadding=2 cellspacing=1 >
					<tr>
						<td  style="font-family:Arial;font-size:13px;" align=right>Прикрепить <B>файл</B></td>
					</tr>
					<tr>	
					...
					<tr>
						<td colspan=3 align=center><input type=submit value='Добавить файл'>	</td>
					</tr>
				</table>
			</form>
