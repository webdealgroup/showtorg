...
$cfg['Servers'][$i]['user']          = 'fxrhf_user';      // MySQL user
$cfg['Servers'][$i]['password']      = 'q1w2e3asda3';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'fxrhfzwm_base';          // If set to a db-name, only
...
$cfg['AllowAnywhereRecoding'] = function_exists("iconv");
