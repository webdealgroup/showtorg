		...
		<td valign="bottom"> 
			...
			<table id="##name##_tab_table" class="wpTabHolder" width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					...
					<!-- begin tab -->
					<!-- begin design -->
					<td id="##name##_designTab" class="wpTButtonUp" onMouseDown="wp_on_mouse_down_tab(this, ##name##)" onClick="##name##.showDesign();"><nobr>&nbsp;<img src="##directory##images/normal.gif" width="10" height="10" alt="" />&nbsp;##design##&nbsp;&nbsp;</nobr></td>
					<!-- end design -->
					<!-- begin html -->
					<td id="##name##_sourceTab" class="wpTButtonDown" onMouseDown="wp_on_mouse_down_tab(this, ##name##)" onClick="##name##.showCode();"><nobr>&nbsp;<img src="##directory##images/html.gif" width="10" height="10" alt="" />&nbsp;##html_code##&nbsp;&nbsp;</nobr></td>
					<!-- end html -->
					<!-- begin preview -->
					<td id="##name##_previewTab" class="wpTButtonDown" onMouseDown="wp_on_mouse_down_tab(this, ##name##)" onClick="##name##.showPreview();"><nobr>&nbsp;<img src="##directory##images/preview.gif" width="10" height="10" alt="" />&nbsp;##preview##&nbsp;&nbsp;</nobr></td>
					<!-- end preview -->
					<!-- end tab -->
