...
// 
// Need help setting up this file? email us: service@wysiwygpro.com
// 
...
define('WP_WEB_DIRECTORY', "https://x-light.by/god/js/editor/");
...
//define('IMAGE_FILE_DIRECTORY', null);


define('IMAGE_FILE_DIRECTORY', "/var/www/vhosts/x-light.by/httpdocs/img/");

//echo "<pre>"; print_r(IMAGE_FILE_DIRECTORY); echo "</pre>"; die();
...
//define('IMAGE_WEB_DIRECTORY', null);

define('IMAGE_WEB_DIRECTORY', "https://x-light.by/img/");
...
define('DOCUMENT_FILE_DIRECTORY', "/var/www/vhosts/x-light.by/httpdocs/docs/");
...
define('DOCUMENT_WEB_DIRECTORY', '/docs/');
...
define('SMILEY_FILE_DIRECTORY', "/var/www/vhosts/x-light.by/httpdocs/img/");
...
$max_image_width = 1500;                         // maximum allowed width of uploaded images in pixels
$max_image_height = 1500;                        // maximum allowed height of uploaded images in pixels
$max_file_size = 1500000;                         // maximum allowed filesize for uploaded images upload in bytes
$max_documentfile_size = 20000000;               // maximum allowed filesize for uploaded documents in bytes
