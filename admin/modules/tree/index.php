...
case "getNode":
	...
	$nodes = rows("SELECT id, name, title as text, parent as parent_id, tpl, status FROM tree WHERE parent_id='".$node."' ORDER BY sort ASC");//AND status = 2 ORDER BY sort ASC");
